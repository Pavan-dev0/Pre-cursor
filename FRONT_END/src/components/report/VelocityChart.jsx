...
export default function VelocityChart({ items = [] }) {
  ...
  const hasFallbackOnly = items.length === 1 && items[0]?.topic === 'Insufficient web signal for this section.'
  ...
  return (
    <div ref={ref} style={{ marginBottom: 56 }}>
      ...
      {hasFallbackOnly ? (
        <div className="font-body" style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 16 }}>
